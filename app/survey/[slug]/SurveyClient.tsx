...
function AscentorMark({ size = 48 }: { size?: number }) {
  return (
    <svg width={size} viewBox="0 0 134.34 101.16" xmlns="http://www.w3.org/2000/svg">
      <path fill="#C8A96E" d="M105.19,71.38H57l-2.73,6.11h53.63ZM83.83,23.62H78.37L58.82,67.39h44.59Zm-2.7,16.32,7.93,18.63H73.19Z"/>
      <polygon fill="#C8A96E" points="74.64 23.64 55.14 67.39 53.36 71.38 50.62 77.54 44.92 77.54 47.66 71.38 49.44 67.39 68.95 23.64 74.64 23.64"/>
      <polygon fill="#C8A96E" points="65.42 23.64 41.39 77.54 35.69 77.54 59.72 23.64 65.42 23.64"/>
      <polygon fill="#C8A96E" points="56.12 23.64 36.61 67.39 34.83 71.38 32.09 77.54 26.39 77.54 29.14 71.38 30.92 67.39 50.42 23.64 56.12 23.64"/>
    </svg>
  );
}
