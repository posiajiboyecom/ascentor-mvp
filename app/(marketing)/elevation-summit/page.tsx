...
export default function ElevationSummitPage() {
    ...
    <>
      ...
      <section id="what-it-is" style={{ background: '#0F0F0E', padding: 'clamp(4rem, 8vw, 7rem) 1.5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ maxWidth: '760px', marginBottom: '4rem' }}>
            <p className="eyebrow" style={{ marginBottom: '1.5rem' }}>What It Is</p>
            <h2 className="section-headline" style={{ color: '#FAFAF8', marginBottom: '1.5rem' }}>
              Not a conference.<br />
              <span style={{ color: '#C8A96E' }}>A defining moment.</span>
            </h2>
            <p style={{ fontSize: '1.0625rem', color: '#9CA3AF', lineHeight: 1.8 }}>
              The Elevation Summit is a deliberate interruption of the ordinary rhythms of life — to ask the questions that drift never allows: <em style={{ color: '#FAFAF8' }}>Who am I becoming? What am I building? What will remain when I am gone?</em>
            </p>
          </div>
      ...
      <section id="register" style={{ padding: 'clamp(4rem, 8vw, 7rem) 1.5rem', maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ maxWidth: '640px', margin: '0 auto' }}>
          <p className="eyebrow" style={{ marginBottom: '1rem', textAlign: 'center' }}>Register Interest</p>
          <h2 className="section-headline" style={{ color: '#0F0F0E', marginBottom: '1rem', textAlign: 'center', fontSize: 'clamp(1.75rem, 3.5vw, 2.5rem)' }}>
            February 2027.<br />Lagos, Nigeria.
          </h2>
          <p style={{ color: '#6B7280', lineHeight: 1.75, marginBottom: '2.5rem', textAlign: 'center', fontSize: '1rem' }}>
            The inaugural Elevation Summit is coming. Register your interest and be among the first to receive details on dates, location, and how to attend.
          </p>
