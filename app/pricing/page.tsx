// app/p/[subdomain]/page.tsx  OR  standalone page at demo.ascentorbi.com
// This is the contact gate shown when a visitor arrives at demo.ascentorbi.com
// before they have been approved by Team Ascentor.
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .dg-cta:hover { background: #F5C55A; transform: translateY(-1px); }
      ...
      <div className="dg-wrap">
        ...
        <div className="dg-card">
          ...
          <p className="dg-body">
            This is a live demonstration of the Ascentor white-label platform &mdash; exactly as your members would experience it. To explore the demo, you first need to be <strong>approved by Team Ascentor</strong>.
          </p>
          ...
          <div className="dg-steps">
            <div className="dg-step">
              ...
              <p className="dg-step-text">
                <strong>Reach out to Team Ascentor</strong> at the email below to introduce yourself and your use case.
              </p>
            </div>
            <div className="dg-step">
              <div className="dg-step-num">2</div>
              <p className="dg-step-text">
                We will schedule a short <strong>discovery call</strong> to understand your goals and walk you through the platform.
              </p>
            </div>
            <div className="dg-step">
              <div className="dg-step-num">3</div>
              <p className="dg-step-text">
                Once approved, you receive <strong>full demo access</strong> and a personalised onboarding session.
              </p>
            </div>
          </div>
          ...
          <p className="dg-secondary">
            ...
            {' '}·{' '}
            <a href="https://ascentorbi.com/pricing" target="_blank" rel="noopener noreferrer">View pricing</a>
          </p>
