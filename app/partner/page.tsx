...
export default async function PartnerOverviewPage() {
  ...
  // Fetch basic stats using partner_members (not tenant_id which belongs to old schema)
  ...
  // Setup checklist — reads from correct fields
  const checklist = [
    {
      done: !!(brand.logo_url),
    ...
    {
      done: !!(brand.primary_color && brand.primary_color !== '#E8A020'),
      label: 'Set your brand colours',
      href: '/partner/brand',
    },
    {
      done: !!(aiConfig.ai_persona_prompt && (aiConfig.ai_persona_prompt as string).length > 100),
