  ...
  return (
    <>
      <style>{`
        ...
        .cp-item-title { font-size: 13px; font-weight: 600; color: #D4CFC3; line-height: 1.4; flex: 1; }
        ...
        .cp-week-tag { font-family: 'DM Mono', monospace; font-size: 9px; color: #4A4438; }
        ...
        .cp-brief-week { font-family: 'DM Mono', monospace; font-size: 9px; color: #4A4438; letter-spacing: 0.1em; white-space: nowrap; }
        .cp-brief-angle { font-size: 13px; color: #7A7260; line-height: 1.6; margin-bottom: 14px; }
        ...
        .cp-brief-items li { font-size: 12px; color: #7A7260; padding-left: 12px; position: relative; line-height: 1.5; }
        .cp-brief-items li::before { content: '→'; position: absolute; left: 0; color: #4A4438; font-size: 10px; }

        /* ── Queue ── */
        .cp-queue-item { background: #1E1C17; border: 1px solid #2E2A22; border-radius: 10px; padding: 14px 16px; display: flex; align-items: flex-start; gap: 14px; margin-bottom: 8px; }
        .cp-queue-time { font-family: 'DM Mono', monospace; font-size: 10px; color: #4A4438; white-space: nowrap; min-width: 80px; padding-top: 2px; }
        .cp-queue-content { flex: 1; font-size: 13px; color: #9A9280; line-height: 1.6; }
        ...
        /* ── Toast ── */
        .cp-toast { position: fixed; bottom: 28px; left: 50%; transform: translateX(-50%); background: #23201A; border: 1px solid rgba(232,160,32,0.25); color: #E8A020; font-family: 'DM Mono', monospace; font-size: 11px; letter-spacing: 0.08em; padding: 10px 20px; border-radius: 8px; z-index: 100; white-space: nowrap; }
              ...
              <div key={post.id} className="cp-queue-item">
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
                    <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, color: '#7A7260', letterSpacing: '0.08em' }}>
                      {post.platform}
                    </span>
...
function ContentDetail({ item, onStatusChange, onPublishToBlog, onCopy, publishing }: {
  ...
  return (
    <>
      ...
      <div className="cp-detail-actions" style={{ marginTop: 20, borderTop: '1px solid #2E2A22', paddingTop: 16 }}>
        {/* Status actions */}
        {item.status === 'draft' && (
    ...
    <div className="cp-brief-card">
      <div className="cp-brief-top">
        ...
        <button
          ...
          style={{ background: 'none', border: 'none', color: '#4A4438', cursor: 'pointer', fontSize: 12, padding: '4px 8px' }}
        >
          {expanded ? '▲' : '▼'}
        </button>
      </div>
        ...
        <div style={{ marginTop: 16, borderTop: '1px solid #2E2A22', paddingTop: 14 }}>
          {d.targetAudience && (
            <div className="cp-brief-section">
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, color: '#4A4438', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 4 }}>Target Audience</p>
              <p style={{ fontSize: 13, color: '#7A7260' }}>{d.targetAudience}</p>
            </div>
          )}
          ...
          {d.urgencyReason && (
            <div className="cp-brief-section">
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, color: '#4A4438', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 4 }}>Why Now</p>
              <p style={{ fontSize: 13, color: '#7A7260' }}>{d.urgencyReason}</p>
            </div>
          )}
          {brief.research_raw && (
            <div className="cp-brief-section">
