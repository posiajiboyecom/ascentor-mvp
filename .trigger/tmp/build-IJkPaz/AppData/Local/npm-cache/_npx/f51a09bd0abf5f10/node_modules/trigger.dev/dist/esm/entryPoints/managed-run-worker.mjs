...
// ../../AppData/Local/npm-cache/_npx/f51a09bd0abf5f10/node_modules/trigger.dev/dist/esm/entryPoints/managed-run-worker.js
init_esm();

// ../../AppData/Local/npm-cache/_npx/f51a09bd0abf5f10/node_modules/@trigger.dev/core/dist/esm/v3/tracer.js
init_esm();
init_esm2();
...
async function doBootstrap() {
  return await runTimelineMetrics.measureMetric("trigger.dev/start", "bootstrap", {}, async () => {
    ...
    const tracingSDK = new TracingSDK({
      ...
      hostMetrics: true,
      hostMetricGroups: getEnvVar("TRIGGER_SYSTEM_METRICS_ENABLED") === "1" ? void 0 : ["process.cpu", "process.memory"],
